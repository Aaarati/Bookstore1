...
$errphone='';
  ...
  if (isset($_POST['submit'])) {
    ...
    else if(!preg_match($numberpattern,$contact)){
      $errphone="Number must start from 98";
    }

    $sql = "INSERT INTO productionhouse(book_name,email,address,phone,price,image)
       VALUES ('$book_name','$email','$address','$contact','$price','$image')";
...
<hr>
 <div class="col-md-10 ">
          ...
          <div class="col-md-12">
            <input type="text" name="contact" placeholder="Contact Number" maxlength="10" class="form-control" >
          <?php echo $errphone; ?>
          </div>
          <div class="col-md-12">
            <input type="text" name="price" placeholder="Price of a book" maxlength="10" class="form-control" required><br>
          </div>
          ...
          <div class="col-md-12 mt-3 ">
            <button class="buttons mb-3"" type="submit" name="submit" >Add Book</button>
